 ...
 */
@Stateless
public class RelatorioAreasCapacidadesFacade extends AbstractFacade<RelatorioAreasCapacidades> {
    ...
    public RelatorioAreasCapacidadesFacade() {
    ...
    public RelatorioAreasCapacidades[] findAllAreasCapacidades(Areas area, String ordem) {
        ...
        RelatorioAreasCapacidades[] arrayAreasCapacidades = new RelatorioAreasCapacidades[lista.size()];
        ...
        for (Object[] item : lista) {            
            ...
            RelatorioAreasCapacidades rac = new RelatorioAreasCapacidades();

...
/*    
    public RelatorioAreasCapacidades[] getArrayCapacidadesAreasPorArea() {
        arrayAreasCapacidades = ejbRACFacade.findAllAreasCapacidades(area,"capacidade");
        return arrayAreasCapacidades;
    }
    
    /**
     * @param arrayAreasCapacidades the arrayAreasCapacidades to set
     *
    public void setArrayAreasCapacidades(RelatorioAreasCapacidades[] arrayAreasCapacidades) {
        this.arrayAreasCapacidades = arrayAreasCapacidades;
    }
*/  
